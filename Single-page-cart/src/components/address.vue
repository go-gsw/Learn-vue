      ...
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          ...
          <div class="shipping-addr-more">
            <a class="addr-more-btn up-down-btn" style="text-decoration: none;color:gray;" href="javascript:" @click="changeLimitnum">
        ...
        <div class="md-modal modal-msg md-modal-transition" id="showModalw" :class="{'md-show':isadd}">
          <div class="md-modal-inner">
            <div class="md-top">
              <button class="md-close" @click="isadd=false">关闭</button>
            </div>
            <div class="md-content">
              <div class="confirm-tips">
...
export default {
  ...
  methods:{
    getAddressList(){
      // let params = {
      //   api: 'static/resource/address.json',
      //   param: ''
      // };
      axios.get('static/resource/address.json')
        .then( res =>{
